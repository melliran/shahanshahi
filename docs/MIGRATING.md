...
- **Features:** Default builds enforce the **legal Shahanshahi era** on [`ShahanshahiDate`](../crates/shahanshahi/src/date.rs). Opt in to **`proleptic`** only if you need dates outside that window under the same civil grid.
