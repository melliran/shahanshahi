...
- **`chrono`:** [`to_chrono_naive_date`](../crates/shahanshahi/src/chrono_compat.rs) returns `Result` because `chrono::NaiveDate` supports only a bounded Gregorian year range, unlike [`GregorianDate`](../crates/shahanshahi/src/gregorian.rs).
