...
- Release automation: [release-plz](https://release-plz.dev/) workflow (draft release PRs; optional gated publish via repo variable `RELEASE_PLZ_PUBLISH`) and [`release-plz.toml`](./release-plz.toml).
